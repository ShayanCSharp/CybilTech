...
<head>
   ...
   <!-- #favicon -->
   <link rel="shortcut icon" href="assets/images/main.png" type="image/x-icon">
   <!-- #title -->
   <title>Cybil Technologies</title>
   <!-- #keywords -->
...
<body>
   ...
   <div class="my-app">
      ...
      <a href="https://api.whatsapp.com/send?phone=3073811695" class="whatsapp">
      ...
      <header class="header">
         <div class="primary-navbar secondary--navbar">
            <div class="container">
               <div class="row">
                  <div class="col-12">
                     <nav class="navbar p-0 justify-content-space-between">
                        <div class="navbar__logo">
                           <a href="index.html" aria-label="go to home">
                              <img src="assets/images/logo.png" alt="Image">
                           </a>
                        </div>
                        <div class="col goMen d-none d-md-flex align-items-center">
                           <h4>Menu</h4>
                  ...
                  <div class="navbar__menu">
                     <ul>
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           <a href="index.html" aria-label="dropdown menu" class="navbar__dropdown-label">Home</a>
                        ...
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           ...
                           <ul class="navbar__sub-menu">
                              <li>
                                 <a href="web-development.html">Website Design & Development</a>
                              </li>
                              <li>
                              ...
                              <li>
                                 <a href="ghost-writing.html">Ghost Writing</a>
                              </li>
                              <li>
                                 <a href="branding.html">Branding</a>
                              </li>
                              <li>
                                 <a href="our-services.html">See more<i class="fa-solid fa-arrow-right"></i></a>
                              </li>
                           </ul>
                        </li>
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           <a href="javascript:void(0)" aria-label="dropdown menu"
                              class="navbar__dropdown-label">Projects</a>
                           <ul class="navbar__sub-menu">
                              <li>
                        ...
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           <a href="javascript:void(0)" aria-label="dropdown menu"
                              class="navbar__dropdown-label">Pages</a>
                           <ul class="navbar__sub-menu">
                              <li>
                        ...
                        <li class="navbar__item navbar__item--has-children nav-fade">
                           <a href="javascript:void(0)" aria-label="dropdown menu"
                              class="navbar__dropdown-label">Blog</a>
                           <ul class="navbar__sub-menu">
                              <li>
         ...
         <div id="smooth-content">
            ...
            <main>
               ...
               <section class="banner">
                  ...
                  <img src="assets/images/main.png" alt="Image" class="banner-one-thumb d-none d-sm-block g-ban-one">
                     ...
                     <div class="row gaper align-items-center">
                        <div class="col-12 col-lg-6">
                           <div class="agency__thumb">
                              <img src="assets/images/service/home.png" alt="Image" class="thumb-one fade-left">
                              <img src="assets/images/service/home1.png" alt="Image" class="thumb-two fade-right">
                           </div>
                        </div>
                        <div class="col-12 col-lg-6">
                           <div class="agency__content section__content">
                              ...
                              <div class="paragraph">
                                 <p>Did you know that hiring digital experts can boost your business’s online presence
                                    by a whopping 87%? These tech-savvy wizards are skilled in the art of optimizing
                                    websites, creating compelling content, and driving targeted traffic. With their
                                    expertise, your brand can make a powerful digital splash and attract a whole new
                                    world of customers.</p>
                              </div>
                              <div class="projectCounter mt-1">
                                 <div class="container">
                                    <div class="row d-flex flex-row">
                                       <div class="col">
                                          <div class="col d-flex flex-column align-items-center">
                                             <h2 class="countNumber">500+</h2>
                                             <p>Successful Website</p>
                                          </div>
                                          <div class="col d-flex flex-column align-items-center">
                                             <h2 class="countNumber">200+</h2>
                                             <p>Web Applications</p>
                                          </div>
                                       </div>
                                       <div class="col">
                                          <div class="col d-flex flex-column align-items-center">
                                             <h2 class="countNumber">100+</h2>
                                             <p>Books Published</p>
                                          </div>
                                          <div class="col d-flex flex-column align-items-center">
                                             <h2 class="countNumber">1,000+</h2>
                                             <p>SEO Strategies</p>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-3">
                           <div class="portfolio__single topy-tilt fade-top">
                              ...
                              <div class="portfolio__single-content">
                                 ...
                                 <h4>
                                    <a href="ghost-writing.html">Ghostwriting</a>
                                 </h4>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-xl-3">
                           <div class="portfolio__single portfolio__single-active topy-tilt fade-top">
                              ...
                              <div class="portfolio__single-content">
                                 ...
                                 <h4>
                                    <a href="coming-soon.html">ChatBot</a>
                                 </h4>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-7 col-xl-6 offset-xl-1">
                           <div class="offer__cta">
                              ...
                              <div class="offer__cta-single fade-top">
                                 ...
                                 <div class="offer-thumb-hover d-none d-md-block"
                                    data-background="assets/images/service/app.webp"></div>
                              </div>
                              <div class="offer__cta-single fade-top">
                                 <span class="sub-title">
                                    03
                  ...
                  <div class="container">
                     ...
                     <div class="row gaper">
                        <div class="col-12 col-md-6">
                           <div class="blog__single fade-top">
                              <div class="blog__single-thumb topy-tilt">
                                 <a href="Top 8 Whiteboard Animation Video Tips.html">
                                    <img src="assets/images/blog/teamwork-concept_23-2147854556.jpg" alt="Image">
                                 </a>
                              </div>
                              <div class="blog__single-content">
                                 <h4>
                                    <a href="Top 8 Whiteboard Animation Video Tips.html">Top 8 Whiteboard Animation Video Tips
                                       in 2024</a>
                                 </h4>
                                 <div class="blog__single-meta">
                                    <a href="Top 8 Whiteboard Animation Video Tips.html" class="sub-title">
                                       creative
                                       <i class="fa-solid fa-arrow-right"></i>
                                    </a>
                                    <p>MARCH 23, 2023</p>
                        ...
                        <div class="col-12 col-md-6">
                           <div class="blog__single fade-top">
                              <div class="blog__single-thumb topy-tilt">
                                 <a href="Social_Media_Video_Animation_Blog.html">
                                    <img src="assets/images/blog/3750605.jpg" alt="Image">
                                 </a>
                              </div>
                              <div class="blog__single-content">
                                 <h4>
                                    <a href="Social_Media_Video_Animation_Blog.html">Using Animated Social Media Marketing 
                                       Videos for Better Content & Ads
                                       </a>
                                 </h4>
                                 <div class="blog__single-meta">
                                    <a href="Social_Media_Video_Animation_Blog.html" class="sub-title">
                                       creative
                                       <i class="fa-solid fa-arrow-right"></i>
                                    </a>
                                    <p>MARCH 23, 2023</p>
               ...
               z<!-- ==== / next page end ==== -->
               <section class="contactForm pt-3">
                  <form action="assets/php/process_form.php" class="d-flex flex-column align-items-center"
                     method="post">
                     <h4>Let’s Connect</h4>
                     <h3 class="text-dark text-center mt-2"><b>Talk To Us & Tell Us About Your Plans, We Are Excited To
                           <br>Help You!</b></h3>

                     <h5 class="text-dark mt-4 text-center">Contact Us and Get Onboard with Cybil Technologies Today!
                     </h5>
                     <div class="inputs d-flex align-items-center mt-4">
                        <div class="userInp">
                           <div class="inpFields">
                              <div class="inp alignFe">
                                 <input type="text" name="name" id="name" placeholder="Name" onkeydown="nameValidate()"
                                    required>
                                 <p class="error" id="nameError">Error</p>
                              </div>
                              <div class="inp alignFe">
                                 <input type="text" name="website" id="website" placeholder="Enter Website"
                                    onkeydown="webValidate()" required>
                                 <p class="error" id="websiteError">Error</p>
                              </div>
                           </div>
                           <div class="inpFields">
                              <div class="inp">
                                 <input type="email" name="email" id="email" placeholder="Email"
                                    onkeydown="emailValidate()" required>
                                 <p class="error" id="emailError">Error</p>
                              </div>
                              <div class="inp">
                                 <input type="text" name="company" id="company" placeholder="Enter Company"
                                    onkeydown="compValidate()" required>
                                 <p class="error" id="companyError">Error</p>
                              </div>
                           </div>

                        </div>
                        <div class="inp align-items-center">
                     ...
                     <div class="col-12 col-lg-5 col-xl-6">
                        <div class="footer__single">
                           ...
                           <div class="footer__single-meta">
                              ...
                              <a href="mailto:info@cybiltechnologies.com">
                                 <i class="fa-sharp fa-solid fa-envelope"></i>
                                 info@cybiltechnologies.com
                              </a>
                           </div>
                              ...
                              <div class="col-12 col-lg-8">
                                 <div class="footer__copyright-text text-center text-lg-start">
                                    <p>
                                       ...
                                       – All Rights Reserved.
                                       <a href="index.html" target="_blank">Cybil Technologies
                                    </p>
                                 </div>
                              </div>
   ...
   <script>
      ...
      $(window).scroll(function () {
         ...
         var offset = $(".projectCounter").offset().top - windowHeight + 100;

         if (scrollPos > offset && !counterAnimated) {
            animateCounters();
      ...
      function animateCounters() {
         ...
         animateCounter($(".countNumber:eq(0)"), 501);
         animateCounter($(".countNumber:eq(1)"), 201);
         animateCounter($(".countNumber:eq(2)"), 101);
         animateCounter($(".countNumber:eq(3)"), 1001);
      }
